...
class TartanAirDataset(Dataset):
    ...
    def __init__(self,
                ...
                to_continuous=False,
                num_classes = 20,
                # data_split='train' # modified by ssg
                data_split='val'
                 ):
